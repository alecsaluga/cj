  ...
  return (
    <div className="grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '32px' }}>
      ...
      <div className="card">
        ...
        <div style={{ fontSize: '32px', fontWeight: 700, margin: '16px 0', color: 'var(--cyan)' }}>$500</div>
      ...
      <div className="card">
        ...
        <div style={{ fontSize: '32px', fontWeight: 700, margin: '16px 0', color: 'var(--cyan)' }}>$650</div>
        <p style={{ fontSize: '14px', opacity: 0.7, marginBottom: '8px' }}>Available: Apr 1 - Sep 1</p>
